...
[![lint](https://github.com/cytopia/docker-pycodestyle/workflows/lint/badge.svg)](https://github.com/cytopia/docker-pycodestyle/actions?query=workflow%3Alint)
[![build](https://github.com/cytopia/docker-pycodestyle/workflows/build/badge.svg)](https://github.com/cytopia/docker-pycodestyle/actions?query=workflow%3Abuild)
[![nightly](https://github.com/cytopia/docker-pycodestyle/workflows/nightly/badge.svg)](https://github.com/cytopia/docker-pycodestyle/actions?query=workflow%3Anightly)
...
View **[Dockerfiles](https://github.com/cytopia/docker-pycodestyle/blob/master/Dockerfiles/)** on GitHub.
...
[![](https://img.shields.io/docker/pulls/cytopia/pycodestyle.svg)](https://hub.docker.com/r/cytopia/pycodestyle)
[![Docker](https://badgen.net/badge/icon/:latest?icon=docker&label=cytopia/pycodestyle)](https://hub.docker.com/r/cytopia/pycodestyle)
...
| Docker Tag           | Git Ref   | PyCodeStyle  | Available Architectures                      |
|----------------------|-----------|--------------|----------------------------------------------|
| `latest`             | master    | latest       | `amd64`, `i386`, `arm64`, `arm/v7`, `arm/v6` |
| `2`                  | master    | **`2.x.x`**  | `amd64`, `i386`, `arm64`, `arm/v7`, `arm/v6` |
| `1`                  | master    | **`1.x.x`**  | `amd64`, `i386`, `arm64`, `arm/v7`, `arm/v6` |
...
| `1-<tag>`            | tag: `<tag>` | **`1.x.x`**  | `amd64`, `i386`, `arm64`, `arm/v7`, `arm/v6` |
